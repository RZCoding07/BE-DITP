...
function interpolate(x, xp, yp) {
  ...
  export const getRulesOfStandarisasiVegetatif = async (req, res) => {
    ...
    const datasets = [
      [
        [29.7, 69.7, 96.7, 134.2, 167.0],[20.7, 36.8, 40.0, 39.6, 56.0],[130.4, 218.9, 280.8, 319.8, 463.9],
        [2.3, 4.0, 4.1, 4.5, 5.3],[1.6, 2.9, 2.4, 2.7, 3.4],[56.7, 78.8, 102.0, 123.1, 124.0],
        [32.1, 56.5, 66.3, 72.7, 86.2],[3.0, 3.7, 3.5, 4.0, 4.5],[116.51, 150.0, 192.5, 235.0, 277.50]
      ],
      [
        [32.0, 64.0, 98.9, 133.2, 173.0],[18.9, 36.1, 39.7, 37.6, 52.0],[155.6, 220.5, 282.9, 342.9, 486.9],
        [2.5, 3.3, 4.2, 4.4, 5.1],[1.7, 2.3, 2.5, 2.5, 3.3],[55.0, 77.2, 96.0, 109.5, 119.0],
        [37.7, 54.9, 63.7, 76.5, 80.9],[3.4, 3.5, 3.8, 4.1, 4.5],[116.51, 150.0, 192.5, 235.0, 277.50]
      ],
      [
        [36.1, 65.9, 95.4, 134.5, 164.0],[23.3, 34.6, 40.2, 40.5, 52.0],[142.1, 208.3, 280.8, 337.0, 456.1],
        [2.3, 3.4, 4.2, 4.3, 5.0],[1.4, 2.4, 2.6, 3.1, 2.9],[60.2, 73.9, 96.4, 119.4, 123.0],
        [3.9, 55.0, 69.5, 74.2, 82.1],[2.8, 3.3, 3.6, 4.1, 4.1],[116.51, 150.0, 192.5, 235.0, 277.50]
      ],
      [
        [36.1, 65.9, 95.4, 134.5, 164.0],[23.3, 34.6, 40.2, 40.5, 52.0],[148, 182.5, , 252.5, 289.5],
        [2.3, 3.4, 4.2, 4.3, 5.0],[1.4, 2.4, 2.6, 3.1, 2.9],[60.2, 73.9, 96.4, 119.4, 123.0],
        [3.9, 55.0, 69.5, 74.2, 82.1],[2.8, 3.3, 3.6, 4.1, 4.3],[116.51, 150.0, 192.5, 235.0, 277.50]
      ],
      [
        [29.7, 69.7, 96.7, 134.2, 167.0],[20.7, 36.8, 40.0, 39.6, 56.0],[140, 190, 240, 285, 340],
        [2.3, 4.0, 4.1, 4.5, 5.3],[1.6, 2.9, 2.4, 2.7, 3.4],[56.7, 78.8, 102.0, 123.1, 124.0],
        [32.1, 56.5, 66.3, 72.7, 86.2],[3.0, 3.7, 3.5, 4.0, 4.5],[116.51, 150.0, 192.5, 235.0, 277.50]
      ]
    ];
    ...
    // Extrapolate for month 1 using the first two available data points (6 and 12 months)
    const y_at_x1 = extrapolate(1, [6, 12], [y_values[0], y_values[1]]);
